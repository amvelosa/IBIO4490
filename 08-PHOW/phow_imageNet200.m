...
%   (~exist(fullfile(conf.calDir, 'zebra'),'dir') && ...
%    ~exist(fullfile(conf.calDir, 'test', 'zebra')))
...
%if ~exist(fullfile(conf.calDir, 'zebra'),'dir')
%  conf.calDir = fullfile(conf.calDir, 'test') ;
%end
